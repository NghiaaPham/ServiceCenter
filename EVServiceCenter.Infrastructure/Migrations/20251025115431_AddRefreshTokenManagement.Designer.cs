...
namespace EVServiceCenter.Infrastructure.Migrations
{
    ...
    [Migration("20251025115431_AddRefreshTokenManagement")]
    partial class AddRefreshTokenManagement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EVServiceCenter.Core.Domains.Identity.Entities.User", b =>
                {
                    ...
                    b.Property<DateOnly?>("PasswordExpiryDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("EVServiceCenter.Core.Entities.PartInventory", b =>
                {
                    ...
                    b.Property<DateOnly?>("LastStockTakeDate")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("EVServiceCenter.Core.Entities.Shift", b =>
                {
                    ...
                    b.Property<TimeOnly?>("ActualBreakEnd")
                        .HasColumnType("time");

                    b.Property<TimeOnly?>("ActualBreakStart")
                        .HasColumnType("time");
            ...
            modelBuilder.Entity("EVServiceCenter.Core.Entities.VehicleHealthMetric", b =>
                {
                    ...
                    b.Property<DateOnly?>("NextCheckDue")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("EVServiceCenter.Core.Entities.Warranty", b =>
                {
                    ...
                    b.Property<DateOnly?>("ClaimedDate")
                        .HasColumnType("date");
