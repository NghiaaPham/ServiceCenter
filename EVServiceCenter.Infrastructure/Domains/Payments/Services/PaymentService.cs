...
public class PaymentService : IPaymentService
{
    ...
    CancellationToken cancellationToken = default)
    {
        // ✅ FIX: Use ExecutionStrategy to support retry + manual transactions
        ...
        CancellationToken cancellationToken)
    {
        ...
        // ✅ FIX: Clean OrderInfo - Remove spaces and special characters
        ...
        // ⚠️ TEMPORARY FIX: Disable IPN URL for testing
        // VNPay requires IPN URL to be registered in their system first
        // vnPayIpnUrl = null; // Temporarily disable IPN

        // ✅ IPN ENABLED: Now testing with production-like flow   

        // ✅ FIX: Log all parameters before sending to VNPay
        // _logger.LogInformation(
        //     "🔍 VNPay Payment Creation Debug:\n" +
        //     "PaymentId: {PaymentId}\n" +
        ...
        var vnpayRequest = new VNPayPaymentRequestDto
        {
            ...
            OrderInfo = cleanOrderInfo, // ✅ Use cleaned OrderInfo without spaces
    ...
    private string BuildVNPayReturnUrl(string? requestedFrontendReturn)
    {
        ...
        // FIX: VNPay KHÔNG CHẤP NHẬN query parameters trong returnUrl
        // Chỉ trả về base return URL, không thêm redirect parameter
        // Frontend redirect sẽ được xử lý trong VNPayReturn endpoint
        _logger.LogInformation(
            "VNPay ReturnUrl configured: {ReturnUrl} (frontend redirect will be handled by controller)",
            baseReturnUrl);

        return baseReturnUrl; // Chỉ return base URL, KHÔNG thêm query params
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        // ✅ GAP 2 FIX: Synchronize payment status to Appointment
        try
        {
