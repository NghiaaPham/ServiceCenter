...
{
    public class UpdateModelServicePricingValidator : AbstractValidator<UpdateModelServicePricingRequestDto>
    {
        public UpdateModelServicePricingValidator()
        {
            RuleFor(x => x.PricingId)
                .GreaterThan(0).WithMessage("Pricing ID không hợp lệ");
