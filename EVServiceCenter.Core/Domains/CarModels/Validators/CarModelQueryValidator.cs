...
{
    public class CarModelQueryValidator : AbstractValidator<CarModelQueryDto>
    {
        private readonly string[] _allowedSortFields = new[]
        {
            "ModelName", "BrandName", "Year", "BatteryCapacity",
            "MaxRange", "CreatedDate", "IsActive"
        };

        public CarModelQueryValidator()
        {
            RuleFor(x => x.Page)
