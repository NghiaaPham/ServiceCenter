...
{
    public class UpdateTimeSlotValidator : AbstractValidator<UpdateTimeSlotRequestDto>
    {
        public UpdateTimeSlotValidator()
        {
            RuleFor(x => x.SlotId)
                .GreaterThan(0)
                .WithMessage("SlotId phải lớn hơn 0");
            ...
            RuleFor(x => x.SlotDate)
                ...
                .WithMessage("Không thể cập nhật slot cho ngày trong quá khứ");
