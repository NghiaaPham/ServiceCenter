...
{
    public class CreateMaintenanceServiceValidator : AbstractValidator<CreateMaintenanceServiceRequestDto>
    {
        private readonly string[] _validSkillLevels = new[] { "Entry", "Intermediate", "Expert" };

        public CreateMaintenanceServiceValidator()
        {
            ...
            RuleFor(x => x.StandardTime)
                ...
                .LessThanOrEqualTo(480).WithMessage("Thời gian chuẩn không được vượt quá 480 phút (8 giờ)");
